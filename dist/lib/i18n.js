...
exports.$_ = $_;
exports.$i18nDoNotTranslate = $i18nDoNotTranslate;
...
var _ = function _(str, options) {
  ...
  if ((typeof str === "undefined" ? "undefined" : _typeof(str)) === "object" && str.messages) {
    str = str.messages[0];
  }
 ...
 */
function $i18nDoNotTranslate(options, str) {
  return str;
};
...
var ngettext = function ngettext(singular, plural, num, options) {
  ...
  if ((typeof singular === "undefined" ? "undefined" : _typeof(singular)) === "object") {
    lang = singular.lang;
 ...
 */
var handlebarsUnderscore = function handlebarsUnderscore(options) {
 ...
 * as is.
 */
var handlebarsDoNotTranslate = function handlebarsDoNotTranslate(options) {
  return options.fn(this);
};
 ...
 */
var handlebarsNgettext = function handlebarsNgettext(num, lang, pos, options) {
 ...
 */
var localeToFixed = function localeToFixed(num, places) {
