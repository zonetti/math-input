                ...
                if (!_this._container.contains(evt.target)) {
                    ...
                    if (_this.props.keypadElement) {
                        ...
                        for (var i = 0; i < evt.changedTouches.length; i++) {
                            var _ref = [evt.changedTouches[i].clientX, evt.changedTouches[i].clientY],
                                x = _ref[0],
                                y = _ref[1];
        ...
        this.setState({ focused: true }, function () {
            ...
            setTimeout(function () {
                if (_this3._isMounted) {
                    ...
                    var maybeKeypadNode = _this3.props.keypadElement && ReactDOM.findDOMNode(_this3.props.keypadElement);
            ...
            React.createElement(
                ...
                React.createElement('div', {
                    ref: function ref(node) {
                        _this5._mathContainer = ReactDOM.findDOMNode(node);
                    },
                    style: innerStyle
                })
            ),
